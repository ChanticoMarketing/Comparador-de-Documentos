        ...
        <CardContent className="p-6">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="10" />
                <line x1="12" y1="8" x2="12" y2="12" />
                <line x1="12" y1="16" x2="12.01" y2="16" />
              </svg>
              <h3 className="mt-4 text-lg font-medium text-white">Error al cargar el historial</h3>
              <p className="mt-1 text-sm text-gray-400">
                {error instanceof Error ? error.message : "No se pudo cargar el historial de comparaciones. Por favor, inicia sesión o inténtalo más tarde."}
              </p>
              <Button
                variant="outline"
                className="mt-4"
                  ...
                  {filteredSessions.map((session) => (
                    <tr key={session.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link href={`/comparison/${session.id}`} className="text-primary-400 hover:text-primary-300 inline-flex items-center">
